...
class ScenarioViewController: UIViewController, UITableViewDelegate, UITableViewDataSource, PopupEventPlayerDelegate, StorySequencePlayerDelegate, SegueHandler {
    ...
    override func viewDidLoad() {
        ...
        // check for and launch an intro story sequence
        startSequence()
    }
